...
public class Fachada {
    ...
    public void alterarLogin(Login login) throws ExceptionErroNoBanco, DadoInexistenteException{
    ...
    public void cadastrarProfessor(Professor professor) throws ExceptionErroNoBanco, EmailInvalidoException, NomeInvalidoException, DadoInexistenteException{
    ...
    public void alterarProfessor(Professor professor) throws ExceptionErroNoBanco, DadoInexistenteException{
    ...
    public void cadastrarAluno(Aluno t) throws ExceptionErroNoBanco, NomeInvalidoException, EmailInvalidoException, DadoInexistenteException{
    ...
    public List<Aluno> recuperarTodosAluno() throws ExceptionErroNoBanco{
     ...
     public void cadastrarFrequencia(Frequencia t) throws ExceptionErroNoBanco, DadoInexistenteException{
    ...
    public void alterarFrequencia(Frequencia t) throws ExceptionErroNoBanco, DadoInexistenteException{
    ...
    public void alterarBacklogMonitor(BacklogMonitor t) throws ExceptionErroNoBanco, DadoInexistenteException{
        this.crudBacklog.alterarBacklogMonitor(t);
    }
    
    public BacklogMonitor recuperarBacklogMonitor(int codigo) throws ExceptionErroNoBanco, DadoInexistenteException{
    ...
    public List<BacklogMonitor> recuperarTodosBacklogMonitor() throws ExceptionErroNoBanco{
     ...
     public void cadastrarMonitor(Monitor t) throws ExceptionErroNoBanco, NomeInvalidoException, EmailInvalidoException, DadoInexistenteException{
    ...
    public void alterarMonitor(Monitor t) throws ExceptionErroNoBanco, DadoInexistenteException{
