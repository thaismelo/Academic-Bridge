...
public class mainProfessor {
    public static void main(String[] args) throws SenhaInvalidaException, SenhaNulaException, LoginNuloOuExistenteException, EmailInvalidoException, NomeInvalidoException , DadoInexistenteException{
        

       Professor p = new Professor(12, 2, 15, "thais", "mariamail@gmail.com");
       try{
           Login l = new Login(2, Login.PROFESSOR, "jokse", "fomefome");
